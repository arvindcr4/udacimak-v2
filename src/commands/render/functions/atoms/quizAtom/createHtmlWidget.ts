...
import type { UdacityWidget } from '../../../../../types/udacity-api';

/**
 * Create HTML for Widget in an ImageFormQuestion
 * @param widget - json data
 */
export default function createHtmlWidget(widget: UdacityWidget): string {
  const {
    group = '', label, marker = '', model, placement,
  } = widget;
